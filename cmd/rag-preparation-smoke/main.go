...
func main() {
	...
	if *withEmbedding {
		input.Embedding = &preparationworkflow.EmbeddingSpec{RawRepresentationName: "raw", MaxRepresentationsPerChunk: 6, Node: ragcontract.Node{Config: []byte(`{"model":"embedding-primary","dimensions":768,"normalize":"l2","batchSize":16}`)}}
	}
