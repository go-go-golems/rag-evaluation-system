// Export a pure researchctl RAG specification without opening a database,
// contacting providers, or allocating lifecycle identity.
const rag = require("rag");

const ttcInputs = rag.fragment("ttc-inputs", (e) =>
	e
