...
export const anchoredCommentRailWidget = defineWidget<AnchoredCommentRailWidgetProps>({
  ...
  render: (props, _children, ctx) => (
    <AnchoredCommentRail
      ...
      onCommentSelect={props.onCommentSelectAction
        ? (commentId) => ctx.dispatchAction(props.onCommentSelectAction!, { commentId, value: commentId, componentType: 'AnchoredCommentRail' })
        : undefined}
    />
  ),
});
