...
func widgetV3TypeScriptLines() []string {
	lines := []string{
		...
		"export interface CourseShellBuilder { active(id: string): this; subtitle(value: WidgetChild): this; contentPadding(value: string): this; main(node: WidgetChild): this; footer(node: WidgetChild): this; onNavigate(action: ActionSpec): this; }",
		"export interface CourseLandingBuilder { activeAgenda(id: string): this; onAgendaSelect(action: ActionSpec): this; onPrimary(action: ActionSpec): this; onSecondary(action: ActionSpec): this; }",
		"export interface CourseSlideDeckBuilder { mode(mode: string): this; visualSide(side: string): this; onPrevious(action: ActionSpec): this; onNext(action: ActionSpec): this; onPresent(action: ActionSpec): this; onFullscreen(action: ActionSpec): this; }",
		"export interface CourseHandoutsBuilder { selected(id: string): this; title(title: WidgetChild): this; empty(message: WidgetChild): this; onSelect(action: ActionSpec): this; onDownload(action: ActionSpec): this; onPrint(action: ActionSpec): this; }",
		"export interface CourseMetadataFormBuilder { title(title: string): this; onSubmit(action: ActionSpec): this; }",
		"export interface CourseMaterialUploadsBuilder { accept(list: string[]): this; onUpload(action: ActionSpec): this; onDelete(action: ActionSpec): this; }",
		...
		"export interface CmsMediaLibraryBuilder {",
		...
		"}",
		"export interface CmsArticleQueueBuilder {",
		...
		"}",
		"export interface CmsMarkdownEditorBuilder {",
		...
		"export interface CrmFieldsBuilder { text(key: string, options?: Record<string, any>): this; longtext(key: string, options?: Record<string, any>): this; email(key: string, options?: Record<string, any>): this; phone(key: string, options?: Record<string, any>): this; url(key: string, options?: Record<string, any>): this; number(key: string, options?: Record<string, any>): this; currency(key: string, options?: Record<string, any>): this; percent(key: string, options?: Record<string, any>): this; date(key: string, options?: Record<string, any>): this; datetime(key: string, options?: Record<string, any>): this; boolean(key: string, options?: Record<string, any>): this; select(key: string, options?: Record<string, any>): this; multiselect(key: string, options?: Record<string, any>): this; tags(key: string, options?: Record<string, any>): this; user(key: string, options?: Record<string, any>): this; relation(key: string, relatedObject: string, options?: Record<string, any>): this; build(): Record<string, any>; validate(): ValidationIssue[]; }",
		"export interface CrmPipelineBuilder { stage(id: string, label: string, options?: Record<string, any>): this; build(): Record<string, any>; validate(): ValidationIssue[]; }",
		"export interface CrmPipelineBoardBuilder { summaries(summaries: Record<string, any>[]): this; selected(dealId: string): this; ariaLabel(label: string): this; onMove(action: ActionSpec): this; onOpen(action: ActionSpec): this; }",
		"export interface CrmRecordFieldsBuilder { mode(mode: 'read' | 'edit'): this; refs(refs: Record<string, any>): this; onChange(action: ActionSpec): this; }",
		"export interface CrmActivityFeedBuilder { groupByDay(value?: boolean): this; onOpen(action: ActionSpec): this; onLoadMore(action: ActionSpec): this; }",
