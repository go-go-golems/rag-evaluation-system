...
func TestWidgetV3TypeScriptModuleDeclaresRootNamespaces(t *testing.T) {
	...
	wantFragments := []string{
		...
		"shell(configure?: Fragment<AppShellBuilder>): PageShellSpec;",
		"export const app: AppNamespace;",
		"export const data: DataNamespace;",
		"export interface PageShortcutSpec",
		"export interface ShortcutsBuilder",
		"bind(id: string, key: string, action: ActionSpec, options: ShortcutOptions): this;",
		...
		"shell(definition: Record<string, any>, configure?: Fragment<CmsShellBuilder>): WidgetNodeSpec;",
