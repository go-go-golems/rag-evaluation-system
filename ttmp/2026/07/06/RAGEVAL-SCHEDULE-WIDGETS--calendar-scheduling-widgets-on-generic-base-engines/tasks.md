...
- [ ] V3 Phase 4: implement widget.dsl data namespace over existing v2 specs and MatrixGrid engine <!-- t:fvsy -->
- [ ] V3 Phase 5-8: implement cms/course/context/schedule/time domain namespaces with typed views and intents <!-- t:b1un -->
- [ ] V3 Phase 9-11: generate declarations/docs, add go-go-course golden fixtures, and document integration/cutover <!-- t:90l0 -->
