...
const documents: CorpusDocumentRow[] = [
	...
	{
		id: "doc_hydrangea_pruning",
		source_id: "ttc-guides",
		title: "Hydrangea Pruning Guide",
		url: "https://example.test/hydrangea",
		word_count: 1320,
		status: "chunked",
		chunk_count: 9,
		embedded_count: 5,
		missing_embedding_count: 4,
	},
	{
		id: "doc_arborvitae_spacing",
		source_id: "ttc-articles",
		title: "Emerald Green Arborvitae Spacing",
		url: "https://example.test/arborvitae",
		word_count: 980,
		status: "pending",
		chunk_count: 0,
		embedded_count: 0,
