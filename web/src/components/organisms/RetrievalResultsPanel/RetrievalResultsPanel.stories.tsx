...
const hybridItems: RetrievalResult[] = [
	{
		...
		retriever: "hybrid",
		preview:
			"Thuja Green Giant and Leyland Cypress are commonly used where a fast evergreen screen is needed...",
		components: {
	...
	},
	{
		...
		retriever: "hybrid",
		preview:
			"For a dense privacy hedge, spacing depends on mature width and how quickly the screen should close...",
		components: {
