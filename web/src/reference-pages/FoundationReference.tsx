	...
	return (
		<>
			...
			<p style={{ color: "#666", marginBottom: "2rem" }}>
				Self-contained visual reference. Every colour, font, spacing value, and component state is
				rendered from the real React components and CSS tokens.
			</p>
			...
			<div className="ds-ref-section">
				...
				{fontRoles.map((role) => (
					<div
						key={role.token}
						style={{ margin: "0.75em 0", borderBottom: "1px solid #eee", paddingBottom: "0.5em" }}
					>
						<div className="ds-ref-label">
				...
				<div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
					{spacing.map((s) => (
						<div key={s.name} style={{ display: "flex", alignItems: "center", gap: 12 }}>
							<div style={{ width: 80, fontFamily: "Monaco, monospace", fontSize: 11 }}>
								{s.name}
							</div>
							<div style={{ width: s.px, height: 16, background: "#000" }} />
							<span style={{ fontFamily: "Monaco, monospace", fontSize: 11, color: "#666" }}>
								{s.px}px
							</span>
						</div>
					))}
				...
				<div className="ds-ref-row">
					{statusStates.map((s) => (
						<div key={s.status} className="ds-ref-item">
							<StatusText status={s.status} icon>
								{s.label}
							</StatusText>
							<div className="ds-ref-code" style={{ marginTop: 4 }}>
								{s.status}
							</div>
						</div>
					))}
				</div>
				<p className="ds-ref-label" style={{ marginTop: "1em" }}>
					Without icon:
				</p>
				<div className="ds-ref-row">
					{statusStates.map((s) => (
				...
				<div className="ds-ref-row">
					{captionTones.map((tone) => (
						<div key={tone + "-upper"} className="ds-ref-item">
							<Caption tone={tone} transform="uppercase">
								{tone} label
							</Caption>
						</div>
					))}
			...
			<div className="ds-ref-section">
				...
				<div className="ds-ref-row">
					<div className="ds-ref-item">
						<Button variant="default" size="normal" selected>
							Selected
						</Button>
					</div>
					<div className="ds-ref-item">
						<Button variant="primary" size="normal" selected>
							Selected Primary
						</Button>
					</div>
				</div>
				...
				<div className="ds-ref-row">
					<div className="ds-ref-item">
						<Button variant="default" size="normal" disabled>
							Disabled
						</Button>
					</div>
					<div className="ds-ref-item">
			...
			<div className="ds-ref-section">
				...
				<ul style={{ paddingLeft: "1.5em", lineHeight: 1.8 }}>
					<li>
						1px solid <code>#000</code> borders on all components
					</li>
					<li>
						Border radius: <strong>0</strong> — no rounding anywhere
					</li>
					<li>No box-shadow or gradients</li>
					<li>
						Focus ring: 2px inset outline in <code>--mac-accent</code>
					</li>
