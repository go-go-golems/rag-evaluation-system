...
const sampleColumns = [
	...
	{ id: "name", header: "Name", cell: (r: (typeof sampleRows)[0]) => r.name },
	{
		id: "status",
		header: "Status",
		cell: (r: (typeof sampleRows)[0]) => (
			<StatusText status={r.status} icon>
				{r.status}
			</StatusText>
		),
	},
...
const metaItems = [
	...
	{ key: "Created", value: "2026-05-27 14:32" },
	{
		key: "Status",
		value: (
			<StatusText status="succeeded" icon>
				Completed
			</StatusText>
		),
	},
	...
	return (
		<>
			...
			<p style={{ color: "#666", marginBottom: "2rem" }}>
				Visual reference for every widget in the design system, rendered from the real React
				components. Shows all key states and how widgets compose.
			</p>

			{/* ── Panel ────────────────────────────────────────── */}
			<div className="ds-ref-section">
				<h2 className="ds-ref-section-title">Panel</h2>
				<p className="ds-ref-label">
					The primary container. Bordered card with optional header and actions.
				</p>
				...
				>
					<StatusText status="running" icon>
						4 queries in queue
					</StatusText>
				</Panel>
			...
			<div className="ds-ref-section">
				...
				<p className="ds-ref-label">
					Vertical flex layout. Gap values: xs(2px), sm(4px), md(8px), lg(16px), xl(24px).
				</p>
			...
			<div className="ds-ref-section">
				...
				<p className="ds-ref-label">
					Horizontal flex. Gap values: xs, sm, md, lg. Justify: start, between, end.
				</p>
				...
				<div className="ds-ref-label" style={{ marginTop: "0.5em" }}>
					justify=between:
				</div>
			...
			<div className="ds-ref-section">
				...
				<p className="ds-ref-label">
					Responsive CSS grid. Recipe: twoColumn (default), searchWorkbench, corpusExplorer.
				</p>
			...
			<div className="ds-ref-section">
				...
				<Panel title="Query Results">
					<DataTable columns={sampleColumns} rows={sampleRows} getRowKey={(r) => r.id} />
				</Panel>
			...
			<div className="ds-ref-section">
				...
				<Panel title="Settings">
					<Stack gap="md">
						<FormRow
							label="Name"
							control={<TextInput defaultValue="" placeholder="Enter name" />}
						/>
						<FormRow
							label="Retriever"
							control={
						...
						<FormRow
							label="Max Results"
							control={<TextInput defaultValue="10" type="number" min={1} max={100} />}
						/>
						<Divider />
						<Inline gap="sm" justify="end">
			...
			<div className="ds-ref-section">
				...
				<p className="ds-ref-label">
					AppShell → AppNav → DashboardGrid → Panel → Stack → StatusText
				</p>
			...
			<div className="ds-ref-section">
				...
				<p className="ds-ref-label">
					DashboardGrid → DataTable (master) + Panel/MetadataGrid (detail)
				</p>
				<DashboardGrid recipe="twoColumn">
					<Panel title="Queries">
						<DataTable
